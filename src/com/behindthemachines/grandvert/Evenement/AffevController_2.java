 ...
 * @author Bouazza Med
 */
public class AffevController_2 implements Initializable {
...
static int id;
    ...
    public void load(){
         EvenementService es =new EvenementService();
                 ...
                 ArrayList evenement=(ArrayList) es.getByuId(StageManager.getStageManager().getUser().getId()).stream().filter(o->o.getUser_id()==StageManager.getStageManager().getUser().getId()).collect(Collectors.toList());  
 ...
 EvenementService ess =new EvenementService();
    ...
    private void modif(ActionEvent event) {
            ...
            stageManager.Load("Evenement/modifev");
